...
def create_model(captcha_length, captcha_num_symbols, input_shape, model_depth=5, module_size=2):
  ...
  x = [keras.layers.Dense(captcha_num_symbols, activation='softmax', name='char_%d'%(i+1))(x) for i in range(1, captcha_length)]
...
def main():
    ...
    # with tf.device('/device:XLA_CPU:0'):
        model = create_model(args.max_length, len(captcha_symbols), (args.height, args.width, 3))
        ...
        training_data = ImageSequence(args.train_dataset, args.batch_size, args.max_length, captcha_symbols, args.width, args.height)
        validation_data = ImageSequence(args.validate_dataset, args.batch_size, args.max_length, captcha_symbols, args.width, args.height)
